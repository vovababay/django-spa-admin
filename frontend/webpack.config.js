...
module.exports = {
    ...
    output: {
        ...
        publicPath: '/static/',  // Используется для доступа к бандлам через Django
    },
    module: {
        rules: [
            {
    ...
    devServer: {
        ...
        devMiddleware: {
            publicPath: '/static/',  // Используется для указания публичного пути для DevServer
        },
    ...
    plugins: [
        ...
        new BundleTracker({
            path: path.resolve(__dirname),  // Путь для сохранения webpack-stats.json
